...
```bash
git remote add encore encore://paxeer-network-website-tnri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/paxeer-network-website-tnri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/paxeer-network-website-tnri/settings/integrations/github)
